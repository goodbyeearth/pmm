...
if __name__ == '__main__':
    ...
    '''加载 expert dataset'''
    dataset = ExpertDataset(expert_path='dataset/1_expert_agent_1_100.npz', traj_limitation=10, verbose=1)
    print("=====> 加载专家数据 ok!")
    ...
    '''保存模块'''
    model.save("model/gail_pmm0")

    # env.close()
    del model # remove to demonstrate saving and loading

    '''加载模块'''
    model = GAIL.load("model/gail_pmm0")
