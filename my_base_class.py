...
class BaseRLModel(ABC):
    ...
    def __init__(self, policy, verbose=0, *, requires_vec_env, policy_base, policy_kwargs=None):
...
class ActorCriticRLModel(BaseRLModel):
    ...
    def __init__(self, policy, _init_setup_model, verbose=0, policy_base=ActorCriticPolicy,
                 requires_vec_env=False, policy_kwargs=None):
        super(ActorCriticRLModel, self).__init__(policy, verbose=verbose, requires_vec_env=requires_vec_env,
