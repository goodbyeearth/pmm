...
def custom_cnn(scaled_images, **kwargs):
    ...
    layer_2 = activ(
        conv(layer_12, 'c2', n_filters=64, filter_size=3, stride=1, init_scale=np.sqrt(2), pad='SAME', **kwargs))
    layer_21 = activ(
    ...
    layer_3 = activ(
        conv(layer_22, 'c3', n_filters=128, filter_size=3, stride=1, init_scale=np.sqrt(2), pad='SAME', **kwargs))
    layer_31 = activ(
