...
class TRPO(ActorCriticRLModel):
    ...
    def __init__(self, policy, gamma=0.99, timesteps_per_batch=1024, max_kl=0.01, cg_iters=10, lam=0.98,
                 entcoeff=0.0, cg_damping=1e-2, vf_stepsize=3e-4, vf_iters=3, verbose=0, tensorboard_log=None,
                 _init_setup_model=True, policy_kwargs=None, full_tensorboard_log=False):
        super(TRPO, self).__init__(policy=policy, verbose=verbose, requires_vec_env=False,
    ...
    def learn(self, total_timesteps, callback=None, seed=None, log_interval=100, tb_log_name="TRPO",
              reset_num_timesteps=True,env=None, save_interval=None,save_path=None):
