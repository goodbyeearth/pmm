...
class TRPO1(ActorCriticRLModel):
    ...
    :param cg_iters: (int) the number of iterations for the conjugate gradient calculation --> 共轭梯度计算的迭代次数
    :param lam: (float) GAE factor --> ?
    :param entcoeff: (float) the weight for the entropy loss
    :param cg_damping: (float) the compute gradient dampening factor -->梯度阻尼因子
    ...
    def setup_model(self):
        ...
        from pmm_adversary import TransitionClassifier
